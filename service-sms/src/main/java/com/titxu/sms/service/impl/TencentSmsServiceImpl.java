...
@Slf4j
@Service("Tencent")
public class TencentSmsServiceImpl implements SmsPlatformService {
    @Override
    public void getSms(SmsDTO dto) {
        try {
            /* 必要步骤：
            ...
            String sdkAppId = SmsProperties.APP_ID;
            ...
            String[] templateParamSet = {dto.getCode()};
            req.setTemplateParamSet(templateParamSet);

            /* 下发手机号码，采用 E.164 标准，+[国家或地区码][手机号]
             * 示例如：+8613711112222， 其中前面有一个+号 ，86为国家码，13711112222为手机号，最多不要超过200个手机号 */
            String[] phoneNumberSet = {"+86" + dto.getPhone()};
            ...
            Assert.equals(sendStatus.getCode(), "Ok", ResponseEnum.ALIYUN_SMS_ERROR);
